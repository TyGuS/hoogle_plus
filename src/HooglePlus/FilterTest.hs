...
runInterpreterWithEnvTimeout = runInterpreter'
...
generateIOPairs modules solution funcSig numPairs timeInMicro interpreterTimeInMicro existingResults existingInputs =
    ...
    buildProp solution funcSig =
      ...
      where
        ...
        formatProp (plain, typed, shows, unwrp) wrappedSolution = unwords
          ...
          , "execStateT (smallCheckM 4 (exists prop)) []" ] :: String
