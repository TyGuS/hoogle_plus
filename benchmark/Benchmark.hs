...
defaultArgs = Args {
  ...
  argsPreset=PartialFunctions &= name "preset" &= help "Component set preset"
  }
...
getSetup args = do
  ...
  componentOldSet <- generateEnv $ getOptsFromPreset PartialFunctions
  ...
  let params =
        case currentExperiment of
          ...
          CompareCopyTransitions -> [
            (searchParamsTyGarQ{_disableCopy=False, _disableBlack=False}, expTyGarQ ++ "-both")   ,
            (searchParamsTyGarQ{_disableCopy=True, _disableBlack=False} , expTyGarQ ++ "-no-copy"),
            (searchParamsTyGarQ{_disableCopy=False, _disableBlack=True} , expTyGarQ ++ "-no-fs")  ,
            (searchParamsTyGarQ{_disableCopy=True, _disableBlack=True}  , expTyGarQ ++ "-neither"),
            (searchParamsTyGarQB{_disableCopy=False, _disableBlack=False}, expTyGarQB ++ "-both"),
            (searchParamsTyGarQB{_disableCopy=True, _disableBlack=False}, expTyGarQB ++ "-no-copy"),
            (searchParamsTyGarQB{_disableCopy=False, _disableBlack=True}, expTyGarQB ++ "-no-fs"),
            (searchParamsTyGarQB{_disableCopy=True, _disableBlack=True}, expTyGarQB ++ "-neither"),
            (searchParamsTyGar0{_disableCopy=False, _disableBlack=False}, expTyGar0 ++ "-both"),
            (searchParamsTyGar0{_disableCopy=True, _disableBlack=False}, expTyGar0 ++ "-no-copy"),
            (searchParamsTyGar0{_disableCopy=False, _disableBlack=True}, expTyGar0 ++ "-no-fs"),
            (searchParamsTyGar0{_disableCopy=True, _disableBlack=True}, expTyGar0 ++ "-neither"),
            (searchParamsNoGar{_disableCopy=False, _disableBlack=False}, expNoGar ++ "-both"),
            (searchParamsNoGar{_disableCopy=True, _disableBlack=False}, expNoGar ++ "-no-copy"),
            (searchParamsNoGar{_disableCopy=False, _disableBlack=True}, expNoGar ++ "-no-fs"),
            (searchParamsNoGar{_disableCopy=True, _disableBlack=True}, expNoGar ++ "-neither")
            ]
  ...
  let exps =
        case currentExperiment of
          CompareEnvironments -> mkExperiments ((componentOldSet, show PartialFunctions):envs) queries params
