...
createEncoder :: [Int] -> [Int] -> [FunctionCode] -> Encoder ()
...
setInitialState :: [Int] -> [Int] -> Encoder ()
...
encoderInc :: [FunctionCode] -> [Int] -> [Int] -> Encoder ()
...
encoderRefine :: SplitInfo -> HashMap Id [Id] -> [Int] -> [Int] -> [FunctionCode] -> HashMap Int (Set Id) -> Encoder ()
...
createVariables :: [Int] -> [Id] -> Encoder ()
...
createConstraints :: [Int] -> [FunctionCode] -> Encoder ()
...
noTransitionTokens :: Int -> Int -> Encoder ()
