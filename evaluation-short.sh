...
HOOGLE_DIR=${HOOGLE_DIR:-/home/hoogle_plus}

SHORT_BENCHMARKS=benchmark/suites/aec-short.yaml

cd $HOOGLE_DIR
mkdir -p $OUTPUTDIR
rm -rf tmp/*

stack exec -- hplus generate --preset=partialfunctions || (echo "failed to create database" && exit 1)
